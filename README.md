...
`PRAYER_SHOW_ICON`: Whether to show the icon prayer time text, format: boolean (`True`/`False`), default: `True`
`PRAYER_SHOW_TOOLTIP_ICON`: Whether to show tooltip icons, format: boolean (`True`/`False`), default: `True`
